...
import { SAH, MeshBVH, FloatVertexAttributeTexture, MeshBVHUniformStruct, UIntVertexAttributeTexture, BVHShaderGLSL } from './three-mesh-bvh.module.js';
...
class WebGLPathTracer {
	...
	updateEnvironment() {
		...
		if ( scene.backgroundRotation ) material.backgroundRotation.makeRotationFromEuler( scene.backgroundRotation ).invert();
		...
		if ( scene.environmentRotation ) material.environmentRotation.makeRotationFromEuler( scene.environmentRotation ).invert();
